  ...
  return (
    <div className={cn("app", mounted ? "mounted" : "")}>
      ...
      <section className="stats-section">
        <div className="stats-grid">
          {siteConfig.stats.map((stat, i) => (
            <div key={stat.label} className={cn("stat-card card-hover glow-hover reveal", `reveal-delay-${i + 1}`)}>
      ...
      <section className="token-section">
        <a href={siteConfig.token.basescan} target="_blank" className={cn("token-card card-hover reveal")}>
      ...
      <section className="contests-section">
        ...
        <div className="contests-grid">
          {siteConfig.contests.map((contest, i) => (
            <div key={contest.name} className={cn("contest-card card-hover reveal", `reveal-delay-${i + 1}`)}>
      ...
      <section className="agents-section" id="agents">
        ...
        <div className="agents-grid">
          {agents.map((agent, i) => (
            <div key={agent.id} className={cn("agent-card card-hover glow-hover reveal", `reveal-delay-${(i % 3) + 1}`)}>
      ...
      <section className="leaderboard-section" id="leaderboard">
        ...
        <div className="leaderboard-grid">
          {agents
            ...
            .map((agent, i) => (
              <div key={agent.id} className={cn("leaderboard-card card-hover", i === 0 && "gold", i === 1 && "silver", i === 2 && "bronze", "reveal")} style={{ transitionDelay: `${i * 0.1}s` }}>
      ...
      <section className="classes-section">
        ...
        <div className="classes-grid">
          {siteConfig.classes.map((cls, i) => (
            <div key={cls.name} className={cn("class-card card-hover glow-hover reveal", `reveal-delay-${(i % 3) + 1}`)}>
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          {siteConfig.features.map((feature, i) => (
            <div key={feature.title} className={cn("feature-card card-hover glow-hover reveal", `reveal-delay-${i + 1}`)}>
      ...
      <section className="contracts-section">
        ...
        <div className="contracts-grid">
          {siteConfig.contracts.map((contract, i) => (
            <a 
              key={contract.name} 
              href={contract.explorer} 
              target="_blank"
              className={cn("contract-card card-hover reveal", `reveal-delay-${i + 1}`)}
            >
