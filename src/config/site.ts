...
export const siteConfig = {
  ...
  // Stats
  stats: [
    { label: "AGENTS", value: "5", trend: "AUTONOMOUS" },
    { label: "CRED", value: "500+", trend: "DISTRIBUTED" },
    { label: "FACTIONS", value: "1", trend: "SUBSTRATE" },
  ...
  // Contest Info
  contests: [
    { name: "ClawdKitchen", date: "Feb 4", status: "REGISTERED", emoji: "🦀" },
    { name: "Saturday Contest", date: "Feb 7", status: "PREPARING", emoji: "🎯" },
  ],
